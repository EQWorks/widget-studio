...
export const DATA_KEY_FORMATTING = {
  ...
  currency : {
    keyList: ['cost', 'spend', 'revenue', 'dealersaleprice', 'dealerreserveprice', 'dmasaleprice','dmareserveprice'],
  ...
  percentage: {
    keyList: ['rate', 'ctr',
      ...
      'Dealer Market Area', 'market area', 'market_area', 'Market Area', "Visitor's Living Area", 'City', 'city', 'Province', 'province', 'Country', 'country',
      ...
      'Unique Visits', 'Repeat Visits', 'Sun', 'Mon', 'Tue', 'Wed', 'Thu', 'Fri',
      'Sat', '9am', '10am', '11am', '12pm', '1pm', '2pm', '3pm', '4pm', '5pm', '6pm', '7pm',
    ],
