...
const useStyles = makeStyles((theme) => ({
  ...
  arrowIcon: { color: theme.palette.primary.main },
}))
    ...
    <FormControl>
      ...
      <div ref={ref}>
        <TextField
          ...
          endAdornment={menuIsOpen ? <ArrowDropUpIcon classes={{ root: classes.arrowIcon }} /> : <ArrowDropDownIcon classes={{ root: classes.arrowIcon }} />}
